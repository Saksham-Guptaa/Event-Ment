...
function Header() {
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 p-5 md:px-10 opacacity-'>
        {/* left */}
        <div className="relative flex items-center h-10 w-10 cursor-pointer my-auto">
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm ">
            ...
            <SearchIcon className="hidden md:inline-flex h-8 bg-yellow-400 text-white rounded-full p-2 cursor-pointer md:mx-2"
             />
        </div>
        {/* middle */}
        ...
        {searchInput &&(
            <div className="flex flex-col col-span-3 mx-auto ">
                ...
                <div className="flex">
                    ...
                    <button className="flex-grow text-yellow-400">Search</button>
                </div>
            </div>
        )}
    </header>
